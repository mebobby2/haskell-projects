...
kMeans' :: (Vector v, Vectorizable e v) => [e] -> RWS Double (Sum Int) [v] () -- Notice how you need to wrap the integer values into the Sum newtype to tell the compiler which of the monoid structures for integers we want to use
